...
<asp:Login ID="LinkOpenIdLogin" RememberMeSet="false" DisplayRememberMe="False" LoginButtonText="Link" runat="server" OnLoggedIn="LinkOpenIdLogin_LoggedIn" MembershipProvider="SqlProvider">
</asp:Login>
    </fieldset>